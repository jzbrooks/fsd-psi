...
public class FsdEnumValueListImpl extends ASTWrapperPsiElement implements FsdEnumValueList {

  public FsdEnumValueListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FsdVisitor visitor) {
    visitor.visitEnumValueList(this);
  }
