...
public class FsdMarkdownRemarksImpl extends ASTWrapperPsiElement implements FsdMarkdownRemarks {

  public FsdMarkdownRemarksImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FsdVisitor visitor) {
    visitor.visitMarkdownRemarks(this);
  }
